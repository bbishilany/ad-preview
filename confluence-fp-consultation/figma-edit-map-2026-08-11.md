# CFP Consultation — Figma On-Image Text Edit Map (text-only pass)
**File:** Confluence FP Design Space (`bTDDRf6J3DYBuNsRTFFnFm`) · **Date:** 2026-08-11
**Scope:** on-image text ONLY. Photos locked — do NOT swap any images. Edit the two text layers ("Eyebrow" + "Headline") inside each frame's **Content** group.
**How to use:** click the link → canvas jumps to that exact ad frame → in the layers panel open **Content** → edit **Eyebrow** and/or **Headline** to the NEW value. Every ad has a Feed (1080×1350) and a Story (1080×1920) frame; apply the same text to both. No change = skip.

Base URL: `https://www.figma.com/design/bTDDRf6J3DYBuNsRTFFnFm/Confluence-FP-Design-Space?node-id=`
...
- Ad 5 Feed: Eyebrow `I1864:65;1859:14`, Headline `I1864:65;1859:15`
- Ad 5 Story: Eyebrow `I1865:165;1862:37`, Headline `I1865:165;1862:38`
- Ad 9 Card 1: Eyebrow `I1865:2799;1861:18`, Headline `I1865:2799;1861:19`
- Other frames follow the same pattern (Content › Eyebrow, Content › Headline) — the layer names are identical across all frames, so the jump link + layer name is unambiguous.
